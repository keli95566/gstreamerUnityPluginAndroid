...
void RenderAPI_OpenGLCoreES::CreateResources()
{
	...
	if (m_APIType == kUnityGfxRendererOpenGLES20)
	{
		...
		LogMessage(ELL_INFO, "using OpenGLES20");
...
void RenderAPI_OpenGLCoreES::EndModifyTexture(void* textureHandle, int textureWidth, int textureHeight,int comps, int rowPitch, void* dataPtr)
{
